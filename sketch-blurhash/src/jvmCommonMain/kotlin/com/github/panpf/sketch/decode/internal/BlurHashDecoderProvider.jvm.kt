 ...
 */
@Keep
actual class BlurHashDecoderProvider : DecoderProvider {

    actual override fun factory(context: PlatformContext): BlurHashDecoder.Factory {
        return BlurHashDecoder.Factory()
    }
}