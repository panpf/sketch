 ...
 *
 * @see com.github.panpf.sketch.animated.gif.koral.test.GifInfoHandlerHelperTest
 */
class GifInfoHandleHelper(val sketch: Sketch, private val dataSource: DataSource) {
