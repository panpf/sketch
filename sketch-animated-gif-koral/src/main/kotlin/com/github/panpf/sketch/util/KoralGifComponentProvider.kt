 ...
 *
 * @see com.github.panpf.sketch.animated.gif.koral.test.util.KoralGifComponentProviderTest
 */
@Keep
class KoralGifComponentProvider : ComponentProvider {
    ...
    override fun addDecoders(context: PlatformContext): List<Decoder.Factory> {
        return listOf(KoralGifDecoder.Factory())
    }
    ...
    override fun toString(): String = "KoralGifComponentProvider"
}