 ...
 *
 * @see com.github.panpf.sketch.http.hurl.common.test.util.HurlHttpComponentProviderTest
 */
@Keep
class HurlHttpComponentProvider : ComponentProvider {

    override fun addFetchers(context: PlatformContext): List<Fetcher.Factory> {
        return listOf(HurlHttpUriFetcher.Factory())
    }
    ...
    override fun toString(): String = "HurlHttpComponentProvider"
}