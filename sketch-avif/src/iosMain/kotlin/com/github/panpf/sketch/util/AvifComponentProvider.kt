...
/**
 * Cooperate with [ComponentLoader] to achieve automatic registration [AppleAvifDecoder].
 *
 * @see com.github.panpf.sketch.avif.ios.test.util.AvifComponentProviderTest
 */
class AvifComponentProvider : ComponentProvider {
    ...
    override fun addDecoders(context: PlatformContext): List<Decoder.Factory> {
        return listOf(AppleAvifDecoder.Factory())
    }
    ...
    override fun toString(): String = "AvifComponentProvider"
}
...
val avifComponentProviderInitHook: Any = ComponentLoader.register(AvifComponentProvider())
