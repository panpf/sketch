 ...
 *
 * @see com.github.panpf.sketch.extensions.apkicon.test.util.ApkIconComponentProviderTest
 */
@Keep
class ApkIconComponentProvider : ComponentProvider {
    ...
    override fun addDecoders(context: PlatformContext): List<Decoder.Factory> {
        return listOf(ApkIconDecoder.Factory())
    }
    ...
    override fun toString(): String = "ApkIconComponentProvider"
}