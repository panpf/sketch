...
class ImageDecoderAnimatedHeifDecoderTest {
    ...
    fun testSupportAnimatedHeif() {
        ...
        ComponentRegistry {
            ...
            assertEquals(
                expected = "ComponentRegistry(" +
                        "fetchers=[]," +
                        "decoders=[ImageDecoderAnimatedHeifDecoder]," +
                        "interceptors=[]" +
                        ")",
                actual = toString()
            )
        ...
        ComponentRegistry {
            ...
            assertEquals(
                expected = "ComponentRegistry(" +
                        "fetchers=[]," +
                        "decoders=[ImageDecoderAnimatedHeifDecoder,ImageDecoderAnimatedHeifDecoder]," +
                        "interceptors=[]" +
                        ")",
                actual = toString()
            )
