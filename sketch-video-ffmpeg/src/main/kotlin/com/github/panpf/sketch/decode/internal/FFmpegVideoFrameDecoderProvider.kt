 ...
 *
 * @see com.github.panpf.sketch.video.ffmpeg.test.decode.internal.FFmpegVideoFrameDecoderProviderTest
 */
@Keep
class FFmpegVideoFrameDecoderProvider : DecoderProvider {

    override fun factory(context: PlatformContext): FFmpegVideoFrameDecoder.Factory {
