...
//    api("com.github.wseemann:FFmpegMediaMetadataRetriever:${property("FFMPEG_MEDIA_METADATA_RETRIEVER")}")
    api("com.github.wseemann:FFmpegMediaMetadataRetriever-core:${property("FFMPEG_MEDIA_METADATA_RETRIEVER")}")
