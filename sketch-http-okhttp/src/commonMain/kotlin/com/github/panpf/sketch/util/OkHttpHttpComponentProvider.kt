 ...
 *
 * @see com.github.panpf.sketch.http.okhttp.common.test.util.OkHttpHttpComponentProviderTest
 */
@Keep
class OkHttpHttpComponentProvider : ComponentProvider {

    override fun addFetchers(context: PlatformContext): List<Fetcher.Factory> {
        return listOf(OkHttpHttpUriFetcher.Factory())
    }
    ...
    override fun toString(): String = "OkHttpComponentProvider"
}