...
* depend: 升级 androidgifdrawable 1.2.32
* depend: 升级 ffmpegMediaMetadataRetriever 1.0.23
...
* improve: 交换内存动作: critical -> clear; warn -> trim
...
* fix: 修复 isHeifFile() 和 isAvifFile() 函数无法正确识别主品牌为 mif1 或 msf1
  的图片格式。[#289](https://github.com/panpf/sketch/issues/289)
