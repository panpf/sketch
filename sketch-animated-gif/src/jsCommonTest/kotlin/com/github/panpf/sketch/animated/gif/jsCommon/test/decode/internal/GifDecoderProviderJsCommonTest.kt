package com.github.panpf.sketch.animated.gif.jscommon.test.decode.internal
...
class GifDecoderProviderJsCommonTest {
    ...
    fun testFactory() {
        ...
        assertTrue(
            actual = decoderFactory is SkiaGifDecoder.Factory,
