...
class ImageDecoderGifDecoderTest {
    ...
    fun testSupportImageDecoderGif() {
        ...
        ComponentRegistry {
            ...
            assertEquals(
                expected = "ComponentRegistry(" +
                        "fetcherFactoryList=[]," +
                        "decoderFactoryList=[ImageDecoderGifDecoder]," +
                        "requestInterceptorList=[]," +
                        "decodeInterceptorList=[]" +
                        ")",
                actual = toString()
        ...
        ComponentRegistry {
            ...
            assertEquals(
                expected = "ComponentRegistry(" +
                        "fetcherFactoryList=[]," +
                        "decoderFactoryList=[ImageDecoderGifDecoder,ImageDecoderGifDecoder]," +
                        "requestInterceptorList=[]," +
                        "decodeInterceptorList=[]" +
                        ")",
                actual = toString()
    ...
    fun testToString() = runTest {
        ...
        assertTrue(actual = decoder.toString().contains("ImageDecoderGifDecoder"))
