    ...
    fun testSupportGif() {
        ...
        ComponentRegistry {
            ...
            assertEquals(
                expected = "ComponentRegistry(" +
                        "fetchers=[]," +
                        "decoders=[GifDecoder(decoderFactory=${defaultGifDecoderFactory()})]," +
                        "interceptors=[]" +
                        ")",
                actual = toString()
            )
        ...
        ComponentRegistry {
            ...
            assertEquals(
                expected = "ComponentRegistry(" +
                        "fetchers=[]," +
                        "decoders=[GifDecoder(decoderFactory=${defaultGifDecoderFactory()}),GifDecoder(decoderFactory=${defaultGifDecoderFactory()})]," +
                        "interceptors=[]" +
                        ")",
                actual = toString()
            )
