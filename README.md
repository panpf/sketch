...
>* [使用手势缩放功能.md](docs/wiki/zoom.md)
>* [使用分块显示超大图功能.md](docs/wiki/large_image.md)
>* [使用缩略图功能显示更清晰的缩略图.md](docs/wiki/thumbnail_mode.md)
>* [配置各种属性.md](docs/wiki/options.md)
>* [使用ImageShaper在绘制时改变图片的形状.md](docs/wiki/image_shaper.md)
>* [使用ShapeSize在绘制时改变图片的尺寸.md](docs/wiki/shape_size.md)
