 ...
 *
 * @see com.github.panpf.sketch.svg.nonjvm.test.util.SvgComponentProviderNonJvmTest
 */
actual class SvgComponentProvider : ComponentProvider {
    ...
    actual override fun addDecoders(context: PlatformContext): List<Decoder.Factory>? {
        return listOf(SvgDecoder.Factory())
    }
    ...
    override fun toString(): String = "SvgComponentProvider"
}