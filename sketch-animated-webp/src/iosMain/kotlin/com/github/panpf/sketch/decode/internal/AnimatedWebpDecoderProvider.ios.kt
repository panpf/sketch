 ...
 *
 * @see com.github.panpf.sketch.animated.webp.ios.test.decode.internal.AnimatedWebpDecoderProviderIosTest
 */
actual class AnimatedWebpDecoderProvider : DecoderProvider {
    ...
    actual override fun factory(context: PlatformContext): Decoder.Factory? {
        return SkiaAnimatedWebpDecoder.Factory()
    }
}
...
val webpDecoderProviderInitHook: Any = ComponentLoader.register(AnimatedWebpDecoderProvider())