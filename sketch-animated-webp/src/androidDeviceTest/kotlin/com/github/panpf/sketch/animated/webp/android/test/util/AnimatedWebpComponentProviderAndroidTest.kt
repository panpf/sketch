package com.github.panpf.sketch.animated.webp.android.test.util
...
class AnimatedWebpComponentProviderAndroidTest {
    ...
    fun testAddAndDisabled() {
        ...
        assertEquals(
            expected = defaultAnimatedWebpDecoderFactory()?.let { listOf(it) },
