 ...
 *
 * @see com.github.panpf.sketch.compose.resources.nonjvm.test.util.ComposeResourceComponentProviderNonJvmTest
 */
actual class ComposeResourceComponentProvider : ComponentProvider {

    actual override fun addFetchers(context: PlatformContext): List<Fetcher.Factory>? {
        return listOf(ComposeResourceUriFetcher.Factory())
    }
    ...
    override fun toString(): String = "ComposeResourceComponentProvider"
}