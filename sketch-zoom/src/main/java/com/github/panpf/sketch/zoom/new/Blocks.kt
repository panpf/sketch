...
import com.github.panpf.sketch.zoom.block.BlockDecoder
import com.github.panpf.sketch.zoom.block.BlockDisplayer
import com.github.panpf.sketch.zoom.block.BlockExecutor
import com.github.panpf.sketch.zoom.block.BlockManager
import com.github.panpf.sketch.zoom.block.DecodeHandler.DecodeErrorException
import com.github.panpf.sketch.zoom.block.ImageRegionDecoder
import com.github.panpf.sketch.zoom.internal.getScale

class Blocks (context: Context, private val imageZoomer: Zoomer, private val imageUri: String, private val exifOrientation: Int) {
...
//                imageZoomer.sketch.bitmapPool.free(bitmap)
//                return
//            }
