...
import com.github.panpf.sketch.zoom.internal.AdaptiveTwoLevelScales
...
import com.github.panpf.sketch.zoom.internal.Sizes
import com.github.panpf.sketch.zoom.internal.TapHelper
import com.github.panpf.sketch.zoom.internal.ZoomScales
import kotlin.math.abs

class Zoomer (val sketch: Sketch, val view: View, _scaleType: ScaleType) {
...
//     * 获取 [ScaleType]
//     */
    private var scaleTypeCache: ScaleType = _scaleType // ImageView 原本的 ScaleType
...
//        recycle(why)
//        sizes.resetSizes(view, view.drawable)
//        if (!isWorking) {
//            return false
//        }
//
//        // 为什么要每次都重新获取 ScaleType ？因为 reset 是可以反复执行的，在此之前 ScaleType 可能会改变
//        scaleTypeCache = view.scaleType
...
//        view.imageMatrix = scaleDragHelper.getDrawMatrix()
