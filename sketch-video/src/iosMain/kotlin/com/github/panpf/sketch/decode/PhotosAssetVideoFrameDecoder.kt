...
/**
 * Add support for video frames from PhotosAsset
 *
 * @see com.github.panpf.sketch.video.ios.test.decode.PhotosAssetVideoFrameDecoderTest.testSupportPhotosAssetVideoFrame
 */
fun ComponentRegistry.Builder.supportPhotosAssetVideoFrame(): ComponentRegistry.Builder = apply {
    add(PhotosAssetVideoFrameDecoder.Factory())
}

/**
 * Decode a frame of a video file from a PhotosAsset and convert it to a bitmap
 *
 ...
 * * colorSpace
 *
 * @see com.github.panpf.sketch.video.ios.test.decode.PhotosAssetVideoFrameDecoderTest
 */
class PhotosAssetVideoFrameDecoder(
    ...
    class Factory : Decoder.Factory {
        ...
        override val key: String = "PhotosAssetVideoFrameDecoder"
        ...
        override fun create(
            ...
            return PhotosAssetVideoFrameDecoder(
                requestContext = requestContext,
                dataSource = dataSource,
                mimeType = mimeType,
            )
        ...
        override fun toString(): String = "PhotosAssetVideoFrameDecoder"
    }
}
