 ...
 *
 * @see com.github.panpf.sketch.video.test.decode.internal.VideoFrameDecoderProviderTest
 */
@Keep
actual class VideoFrameDecoderProvider : DecoderProvider {

    actual override fun factory(context: PlatformContext): VideoFrameDecoder.Factory {
