...
//        }
//        (ImageRequest(context1, uriString1) as ImageRequest).newBuilder {
//            depth(LOCAL)
//        }.build().apply {
//            Assert.assertEquals(LOCAL, depth)
//        }
...
//            Assert.assertEquals(LOCAL, depth)
//        }
//        (ImageRequest(context1, uriString1) as ImageRequest).newRequest {
//            depth(LOCAL)
//        }.apply {
//            Assert.assertEquals(LOCAL, depth)
//        }
//
//        ImageRequest(context1, uriString1).newDownloadBuilder().build().apply {
//            Assert.assertEquals(NETWORK, depth)
//            Assert.assertNull(listener)
//            Assert.assertNull(progressListener)
//        }
//        ImageRequest(context1, uriString1).newDownloadBuilder {
//            depth(LOCAL)
//            listener(
...
//                },
//            )
//            progressListener { request: ImageRequest, totalLength: Long, completedLength: Long ->
//
//            }
//        }.build().apply {
//            Assert.assertEquals(LOCAL, depth)
...
//        }
//
//        ImageRequest(context1, uriString1).newDownloadRequest().apply {
//            Assert.assertEquals(NETWORK, depth)
//            Assert.assertNull(listener)
//            Assert.assertNull(progressListener)
//        }
//        ImageRequest(context1, uriString1).newDownloadRequest {
//            depth(LOCAL)
//            listener(
//                onStart = { request: ImageRequest ->
//
...
//            listener(onSuccess = { _, _ -> })
//            val listener2 =
//                object : Listener<ImageRequest, ImageResult.Success, ImageResult.Error> {}
//            val listener3 =
//                object : Listener<ImageRequest, ImageResult.Success, ImageResult.Error> {}
...
//
//            progressListener { _, _, _ -> }
//            val progressListener2 = ProgressListener<ImageRequest> { _, _, _ -> }
//            val progressListener3 = ProgressListener<ImageRequest> { _, _, _ -> }
