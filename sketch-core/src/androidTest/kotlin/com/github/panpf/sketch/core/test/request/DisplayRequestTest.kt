...
//        }
//
//        ImageRequest(context1, uriString1).newDisplayBuilder().build().apply {
//            Assert.assertEquals(NETWORK, depth)
//            Assert.assertNull(listener)
//            Assert.assertNull(progressListener)
//        }
//        ImageRequest(context1, uriString1).newDisplayBuilder {
//            depth(LOCAL)
//            listener(
...
//        }
//
//        ImageRequest(context1, uriString1).newDisplayRequest().apply {
//            Assert.assertEquals(NETWORK, depth)
//            Assert.assertNull(listener)
//            Assert.assertNull(progressListener)
//        }
//        ImageRequest(context1, uriString1).newDisplayRequest {
//            depth(LOCAL)
//            listener(
//                onStart = { request: ImageRequest ->
//
