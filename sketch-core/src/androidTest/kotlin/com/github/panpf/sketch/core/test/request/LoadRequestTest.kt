...
class LoadRequestTest {
    ...
    fun testListener() {
        ...
        LoadRequest.Builder(context1, uriString1).apply {
            ...
            listener(onSuccess = { _, _ -> })
            val listener2 =
                object : Listener<LoadRequest, LoadResult.Success, LoadResult.Error> {}
            val listener3 =
                object : Listener<LoadRequest, LoadResult.Success, LoadResult.Error> {}
    ...
    fun testProgressListener() {
        ...
        LoadRequest.Builder(context1, uriString1).apply {
            ...
            progressListener { _, _, _ -> }
            val progressListener2 = ProgressListener<LoadRequest> { _, _, _ -> }
            val progressListener3 = ProgressListener<LoadRequest> { _, _, _ -> }
    ...
    fun testComponents() {
        ...
        LoadRequest(context, AssetImages.jpeg.uri).apply {
    ...
    fun testEqualsAndHashCode() {
        val context = getTestContext()
        val element1 = LoadRequest(context, AssetImages.jpeg.uri)
        val element11 = LoadRequest(context, AssetImages.jpeg.uri)
        val element2 = LoadRequest(context, AssetImages.png.uri)
