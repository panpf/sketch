...
//        }
//
//        ImageRequest(context1, uriString1).newLoadBuilder().build().apply {
//            Assert.assertEquals(NETWORK, depth)
//            Assert.assertNull(listener)
//            Assert.assertNull(progressListener)
//        }
//        ImageRequest(context1, uriString1).newLoadBuilder {
//            depth(LOCAL)
//            listener(
...
//        }
//
//        ImageRequest(context1, uriString1).newLoadRequest().apply {
//            Assert.assertEquals(NETWORK, depth)
//            Assert.assertNull(listener)
//            Assert.assertNull(progressListener)
//        }
//        ImageRequest(context1, uriString1).newLoadRequest {
//            depth(LOCAL)
//            listener(
//                onStart = { request: ImageRequest ->
//
