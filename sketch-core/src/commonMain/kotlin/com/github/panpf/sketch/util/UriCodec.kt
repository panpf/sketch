...
/**
 * https://github.com/eygraber/uri-kmp/blob/master/uri/src/commonMain/kotlin/com/eygraber/uri/UriCodec.kt
 */
object UriCodec {
    /**
     ...
     *  or null if s is null
     */
    public fun encodeOrNull(s: String?, allow: String?): String? =
        if (s == null) null else encode(s, allow)
