...
class UriTest {
    ...
    fun testToUri() {
        assertEquals(
            expected = "https://example.com/image.jpg?q=jpg#fragment",
            actual = "https://example.com/image.jpg?q=jpg#fragment".toUri(separator = "/")
                .toString()
        )
        assertEquals(
            expected = "https://example.com/image.jpg?q=jpg#fragment",
    ...
    fun testBuildUri() {
        ...
        assertEquals(
            expected = "http:",
            actual = buildUri(scheme = "http").toString()
        )
        assertEquals(
            expected = "http://sample.com",
            actual = buildUri(scheme = "http", authority = "sample.com").toString()
        )
        assertEquals(
            expected = "http://sample.com/avatar/my.png",
            actual = buildUri(
                scheme = "http",
                authority = "sample.com",
                path = "/avatar/my.png"
            ).toString()
        )
        assertEquals(
            expected = "http://sample.com/avatar/my.png?key1=value1&key2=value2",
            actual = buildUri(
                scheme = "http",
                authority = "sample.com",
                path = "/avatar/my.png",
        ...
        assertEquals(
            expected = "http://sample.com/avatar/my.png?key1=value1&key2=value2#fragment1",
            actual = buildUri(
                scheme = "http",
                authority = "sample.com",
                path = "/avatar/my.png",
    ...
    @Test
    fun windowsPath2() {
        val uri = "file://D:\\test\\relative\\image.jpg".toUri(separator = "\\")
        assertEquals("file", uri.scheme)
        assertEquals("D:", uri.authority)
        assertEquals("/test/relative/image.jpg", uri.path)
        assertEquals("test\\relative\\image.jpg", uri.filePath)
        assertEquals(listOf("test", "relative", "image.jpg"), uri.pathSegments)
        assertNull(uri.query)
    ...
    fun windowsPath3() {
        val uri = "file://D:\\test\\relative\\image.jpg".toUri(separator = "/")
        assertEquals("file", uri.scheme)
        assertEquals("D:\\test\\relative\\image.jpg", uri.authority)
        assertNull(uri.path)
        assertNull(uri.filePath)
        assertEquals(emptyList(), uri.pathSegments)
        assertNull(uri.query)
        assertNull(uri.fragment)
    }
