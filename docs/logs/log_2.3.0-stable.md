...
##### Log
>* :hammer: `Log` 日志分不同的类型分别提供开关控制，详见[SLogType.java](../../sample/src/java/me/xiaopan/sketchsample/SLogType.java)
>* :sparkles: `SLogTracker` 新增SLogTracker用于收集Sketch的日志，详情可参看示例APP中的[SampleLogTracker.java](../../sample/src/java/me/xiaopan/sketchsample/SampleLogTracker.java)
