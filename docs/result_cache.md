...
The result caching function is managed by [ResultCacheInterceptor], and [DiskCache] is
managed
...
```kotlin
// The result cache key can be obtained through RequestContext in the customized Interceptor, 
