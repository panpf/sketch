...
//                rememberIconAnimatablePainterStateImage(icon = rememberIconPlaceholderEclipseAnimatedPainter(), background = colorScheme.onPrimaryContainer)
//                val request = ImageRequest(LocalPlatformContext.current, uriString) {
