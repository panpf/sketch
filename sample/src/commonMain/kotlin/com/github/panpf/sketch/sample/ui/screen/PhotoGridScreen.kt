...
//            }
    ...
    private fun pagingFlow(): Flow<PagingData<Photo>> {
        ...
        return when (photoSource) {
            PhotoSource.Local -> rememberScreenModel { LocalPhotoListScreenModel(context, sketch) }.pagingFlow
            PhotoSource.Pexels -> rememberScreenModel { PexelsPhotoListScreenModel() }.pagingFlow
            PhotoSource.Giphy -> rememberScreenModel { GiphyPhotoListScreenModel() }.pagingFlow
        }
    }
...
//                }
                ...
                crossfade()   // TODO
//                resizeOnDraw()    // TODO
//                merge(appSettingsService.buildListImageOptions())   // TODO
            }
        }
        when (index % 3) {
            0 -> {
