...
class PexelsPhotosFragment2 : ToolbarBindingFragment<FragmentRecyclerBinding>() {
        ...
        binding.recyclerRecyclerFragmentContent.apply {
            appSettingsService.photoListLayoutMode.observe(viewLifecycleOwner) {
                ...
                val pagingAdapter = AssemblyPagingDataAdapter<Photo>(listOf(
                    CoilPhotoItemFactory().setOnViewClickListener(R.id.imageItemImageView) { _, _, _, absoluteAdapterPosition, _ ->
