...
public abstract class ExtendableListView extends AbsListView {
    ...
    private HeaderViewListAdapter.OnGetFooterViewListener onGetFooterViewListener;
    ...
    public void setAdapter(final ListAdapter adapter) {
        ...
        if (mHeaderViewInfos.size() > 0 || mFooterViewInfos.size() > 0) {
            ...
            ((HeaderViewListAdapter) mAdapter).setOnGetFooterViewListener(onGetFooterViewListener);
        } else {
            mAdapter = adapter;
        }
    ...
    public void setOnGetFooterViewListener(HeaderViewListAdapter.OnGetFooterViewListener onGetFooterViewListener) {
        this.onGetFooterViewListener = onGetFooterViewListener;
