...
public class BaiduImageGridAdapter extends BaseAdapter {
	...
	public BaiduImageGridAdapter(Context context, List<ImageSearchRequest.Image> imageList, int column, int horizontalSpacing){
