...
public class AppPackageListAdapter extends RecyclerView.Adapter{
    ...
    public AppPackageListAdapter(List<AppInfo> appInfoList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if(viewType == 0){
            ...
            return new AppInfoViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_app, parent, false));
        }
    }
