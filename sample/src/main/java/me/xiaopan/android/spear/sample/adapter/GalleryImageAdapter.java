...
public class GalleryImageAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.gallery_item_image, parent, false);
            viewHolder.progressPieView = (ProgressPieView) convertView.findViewById(R.id.progress_galleryItem_progress);
            viewHolder.progressPieView.setMax(100);
			viewHolder.image = (SpearImageView) convertView.findViewById(R.id.image_galleryItem);
            viewHolder.image.setDisplayOptions(DisplayOptionsType.GALLERY);
