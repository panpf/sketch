 ...
 * 百度图片
 */
@InjectContentView(R.layout.activity_baidu_image)
public class BaiduImageActivity extends MyActionBarActivity{
    @InjectView(R.id.drawer_baiduImage) private DrawerLayout drawerLayout;
    @InjectView(R.id.list_baiduImage_category) private ListView categoryListView;
