...
public class StarActivity extends MyActionBarActivity {
    ...
    @InjectExtra(StarFragment.PARAM_REQUIRED_STRING_STAR_TITLE) private String starTitle;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        starFragment.setArguments(getIntent().getExtras());

        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.frame_search_content, starFragment)
                .commit();
	}
