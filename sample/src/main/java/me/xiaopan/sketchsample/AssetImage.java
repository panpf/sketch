...
public class AssetImage {
    public static final String TYPE_TEST_JPG = "http://or84z82rx.bkt.clouddn.com/sample.jpg";
    public static final String TYPE_TEST_PNG = "http://or84z82rx.bkt.clouddn.com/sample.png";
    public static final String TYPE_TEST_GIF = "http://or84z82rx.bkt.clouddn.com/sample.gif";
    public static final String TYPE_TEST_WEBP = "http://or84z82rx.bkt.clouddn.com/sample.webp";
    public static final String TYPE_TEST_BMP = "http://or84z82rx.bkt.clouddn.com/sample.bmp";
    ...
    public static final String URI_TEST_ANDR_RES_BY_NAME = AndroidResUriModel.makeUriByName(BuildConfig.APPLICATION_ID, "drawable", "ic_video_play");
    public static final String URI_TEST_ANDR_RES_BY_NAME2 = AndroidResUriModel.makeUriByName(BuildConfig.APPLICATION_ID, "mipmap", "ic_launcher");
    public static final String URI_TEST_ANDR_RES_BY_ID = AndroidResUriModel.makeUriById(BuildConfig.APPLICATION_ID, R.mipmap.ic_launcher);
    public static final String URI_TEST_ANDR_RES_BY_NAME3 = AndroidResUriModel.makeUriByName("com.android.settings", "drawable", "ic_launcher");
    public static final String URI_TEST_APP = AppIconUriModel.makeUri(BuildConfig.APPLICATION_ID, BuildConfig.VERSION_CODE);
    public static final String URI_TEST_ASSET = "asset://mei_nv.jpg";
    public static final String URI_TEST_DRAWABLE = DrawableUriModel.makeUri(R.mipmap.ic_launcher);
    ...
    public static String[] getAll(Context context) {
        ...
        Collections.addAll(stringList, TYPE_TEST_JPG,
                ...
                CHUNK,
                CHUNK2);
        Collections.addAll(stringList, getTestUris(context));
        return stringList.toArray(new String[stringList.size()]);
    }

    public static String[] getTestUris(Context context) {
        try {
            return new String[]{
                    URI_TEST_ASSET,
                    URI_TEST_APP,
                    ApkIconUriModel.makeUri(context.getPackageManager().getApplicationInfo(context.getPackageName(), 0).sourceDir),
