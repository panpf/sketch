 ...
 * 保存图片异步任务
 */
public class SaveAssetImageAsyncTask extends AsyncTask<String, Integer, String> {

    private Context context;
    private String assetFileName;

    public SaveAssetImageAsyncTask(Context context, String assetFileName) {
    ...
    protected String doInBackground(String... params) {
        ...
        File outImageFile = new File(dir, assetFileName);
        try {
