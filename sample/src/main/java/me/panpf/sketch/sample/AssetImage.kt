...
object AssetImage {
    ...
    val URI_TEST_ANDR_RES_BY_NAME = AndroidResUriModel.makeUriByName(
        BuildConfig.APPLICATION_ID,
        "drawable",
        "ic_play"
    )
    // todo 支持 svg 图片
    val URI_TEST_ANDR_RES_BY_NAME2 =
        AndroidResUriModel.makeUriByName(BuildConfig.APPLICATION_ID, "mipmap", "ic_launcher")
    val URI_TEST_ANDR_RES_BY_ID =
        AndroidResUriModel.makeUriById(BuildConfig.APPLICATION_ID, R.mipmap.ic_launcher)
    val URI_TEST_ANDR_RES_BY_NAME3 =
        AndroidResUriModel.makeUriByName("com.android.settings", "drawable", "ic_launcher")
    val URI_TEST_APP = AppIconUriModel.makeUri(BuildConfig.APPLICATION_ID, BuildConfig.VERSION_CODE)
    const val URI_TEST_ASSET = "asset://mei_nv.jpg"
    val URI_TEST_DRAWABLE = DrawableUriModel.makeUri(R.mipmap.ic_launcher)

    val IN_BITMAP_SAMPLES =
        arrayOf(TYPE_TEST_JPG, TYPE_TEST_PNG, TYPE_TEST_GIF, TYPE_TEST_WEBP, TYPE_TEST_BMP)

    val HUGE_IMAGES = arrayOf(HUGE_WORLD_MAP, HUGE_QMSHT, HUGE_CHANG_WEI_BO, HUGE_CARD)
    const val URI_TEST_BASE64 =
...
//    fun getAll(context: Context): Array<String> {
//        val stringList = ArrayList<String>()
//        Collections.addAll(
//            stringList, TYPE_TEST_JPG,
//            TYPE_TEST_PNG,
//            TYPE_TEST_GIF,
//            TYPE_TEST_WEBP,
//            TYPE_TEST_BMP,
