...
class ImageFromViewModel(application1: Application) : LifecycleAndroidViewModel(application1) {
    ...
    private fun load() {
        viewModelScope.launch {
            val localFirstPhotoUrl = loadLocalFirstPhoto()
            val localFirstVideoUrl = loadLocalFirstVideo()
            ...
            val datas = ArrayList<Pair<String, String>>().apply {
                ...
                if (localFirstPhotoUrl != null) {
                    add("FILE" to localFirstPhotoUrl)
                }
                if (localFirstVideoUrl != null) {
                    add("VIDEO THUMBNAIL" to localFirstVideoUrl)
                }
    ...
    private suspend fun loadLocalFirstPhoto(): String? {
        return withContext(Dispatchers.IO) {
    ...
    private suspend fun loadLocalFirstVideo(): String? {
        return withContext(Dispatchers.IO) {
            val cursor = application1.contentResolver.query(
