...
public class BitmapProcessorUtils {
	public static Rect computeSrcRect(Point sourceSize, Point targetSize, ScaleType scaleType){
        if(scaleType == ScaleType.CENTER_INSIDE || scaleType == ScaleType.MATRIX || scaleType == ScaleType.FIT_XY){
