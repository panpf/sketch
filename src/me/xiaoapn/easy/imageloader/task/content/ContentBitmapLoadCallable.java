...
import me.xiaoapn.easy.imageloader.decode.ContentInputStreamCreator;
...
public class ContentBitmapLoadCallable implements Callable<BitmapDrawable> {
	...
	public BitmapDrawable call() throws Exception {
		...
		try{
			...
			if(bitmapDrawable == null){
				//解码
				Bitmap bitmap = configuration.getBitmapDecoder().decode(new ContentInputStreamCreator(configuration.getContext(), request.getImageUri()), request.getTargetSize(), configuration, request.getName());
