...
import com.github.panpf.sketch.extensions.core.R
...
class ImageXmlAttributes(val options: ImageOptions?)

fun parseImageXmlAttributes(context: Context, attrs: AttributeSet? = null): ImageXmlAttributes {
