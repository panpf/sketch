 ...
 */
package com.github.panpf.sketch.extensions.core.test.viewability
...
class ClickIgnoreSaveCellularTrafficAbilityTest {
    ...
    fun testExtensions() {
        ...
        imageView.setClickIgnoreSaveCellularTrafficEnabled(context.sketch)
        Assert.assertTrue(imageView.isClickIgnoreSaveCellularTrafficEnabled)

        imageView.setClickIgnoreSaveCellularTrafficEnabled(context.sketch, false)
        Assert.assertFalse(imageView.isClickIgnoreSaveCellularTrafficEnabled)

        imageView.setClickIgnoreSaveCellularTrafficEnabled(context.sketch, true)
        Assert.assertTrue(imageView.isClickIgnoreSaveCellularTrafficEnabled)
    }
}