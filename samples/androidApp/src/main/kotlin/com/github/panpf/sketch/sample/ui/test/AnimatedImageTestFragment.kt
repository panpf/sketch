...
class AnimatedImageTestFragment :
    ...
    override fun onViewCreated(
        ...
        binding.formatWebpImage.loadImage(ComposeResImageFiles.animWebp.uri) {
            placeholder(
                IconDrawableStateImage(
                    icon = R.drawable.ic_image_outline,
                    background = R.color.md_theme_primaryContainer,
        ...
        binding.formatHeifImage.loadImage(ComposeResImageFiles.animHeif.uri) {
            placeholder(
                IconDrawableStateImage(
                    icon = R.drawable.ic_image_outline,
                    background = R.color.md_theme_primaryContainer,
        ...
        platformGifDecoders().forEachIndexed { index, factory ->
            ...
            repeatCountImages[index].loadImage(ComposeResImageFiles.numbersGif.uri) {
                placeholder(
                    IconDrawableStateImage(
                        icon = R.drawable.ic_image_outline,
                        background = R.color.md_theme_primaryContainer,
        ...
        platformGifDecoders().forEachIndexed { index, factory ->
            ...
            callbackImages[index].loadImage(ComposeResImageFiles.numbersGif.uri) {
                placeholder(
                    IconDrawableStateImage(
                        icon = R.drawable.ic_image_outline,
                        background = R.color.md_theme_primaryContainer,
        ...
        platformGifDecoders().forEachIndexed { index, factory ->
            ...
            transformationImages[index].loadImage(ComposeResImageFiles.animGif.uri) {
                placeholder(
                    IconDrawableStateImage(
                        icon = R.drawable.ic_image_outline,
                        background = R.color.md_theme_primaryContainer,
