...
public class ImageSize {
	...
	public static ImageSize createMaxsize(ImageView imageView, ImageSize maxsize) {
	...
	public static ImageSize createResize(ImageView imageView, ImageSize maxProcessSize) {
