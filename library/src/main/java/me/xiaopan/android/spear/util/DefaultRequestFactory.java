...
public class DefaultRequestFactory implements RequestFactory{
    ...
    @Override
    public LoadRequest newLoadRequest(Spear spear, String uri, UriScheme uriScheme) {
        return new LoadRequestImpl(spear, uri, uriScheme);
    }

    @Override
    public DownloadRequest newDownloadRequest(Spear spear, String uri, UriScheme uriScheme) {
        return new DownloadRequestImpl(spear, uri, uriScheme);
    }
}
