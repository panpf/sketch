...
class GifDrawableWrapperDrawableTest {
    ...
    fun testEqualsAndHashCode() {
        ...
        val movie = GifDrawable(context.assets, MyImages.animGif.fileName)
        val movie2 = GifDrawable(context.assets, MyImages.animGif.fileName)
        val movie3 = GifDrawable(context.assets, MyImages.animGif.fileName)
