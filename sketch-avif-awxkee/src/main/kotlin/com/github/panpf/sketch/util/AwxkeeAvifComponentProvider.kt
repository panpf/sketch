...
/**
 * Cooperate with [ComponentLoader] to achieve automatic registration [AwxkeeAvifDecoder]
 *
 * @see com.github.panpf.sketch.avif.awxkee.test.util.AwxkeeAvifComponentProviderTest
 */
@Keep
class AwxkeeAvifComponentProvider : ComponentProvider {
    ...
    override fun addDecoders(context: PlatformContext): List<Decoder.Factory>? {
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            listOf(AwxkeeAvifDecoder.Factory())
        } else {
            null
        }
    }
    ...
    override fun toString(): String = "AwxkeeAvifComponentProvider"
}