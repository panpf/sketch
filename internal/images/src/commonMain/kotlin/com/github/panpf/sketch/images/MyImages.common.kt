...
object MyImages {
    ...
    val bmp: MyResourceImage = MyResourceImage("sample.bmp", "BMP", Size(700, 1012))
    val heic: MyResourceImage = MyResourceImage("sample.heic", "HEIC", Size(750, 931))
    val jpeg: MyResourceImage = MyResourceImage("sample.jpeg", "JPEG", Size(1291, 1936))
    val png: MyResourceImage = MyResourceImage("sample.png", "PNG", Size(750, 719))
    val svg: MyResourceImage = MyResourceImage("sample.svg", "SVG", Size(256, 225))
    val webp: MyResourceImage = MyResourceImage("sample.webp", "WEBP", Size(1080, 1344))
    val statics = arrayOf(jpeg, png, webp, bmp, svg, heic)

    val animGif: MyResourceImage = MyResourceImage("sample_anim.gif", "GIF", Size(480, 480))
    val animHeif: MyResourceImage = MyResourceImage("sample_anim.heif", "HEIF_ANIM", Size(256, 144))
    val animWebp: MyResourceImage = MyResourceImage("sample_anim.webp", "WEBP_ANIM", Size(480, 270))
    val anims = arrayOf(animGif, animWebp, animHeif)

    val mp4: MyResourceImage = MyResourceImage("sample.mp4", "MP4", Size(500, 250))
    val videos = arrayOf(mp4)

    val longQMSHT: MyResourceImage = MyResourceImage("sample_long_qmsht.jpg", "QMSHT", Size(30000, 926))

    val clockExifFlipHorizontal: MyResourceImage = MyResourceImage(
        "clock_exif_flip_horizontal.jpeg",
        "FLIP_HOR",
        Size(1500, 750),
        ExifOrientationHelper.FLIP_HORIZONTAL
    )
    val clockExifFlipVertical: MyResourceImage = MyResourceImage(
        "clock_exif_flip_vertical.jpeg",
        "FLIP_VER",
        Size(1500, 750),
        ExifOrientationHelper.FLIP_VERTICAL
    )
    val clockExifNormal: MyResourceImage = MyResourceImage(
        "clock_exif_normal.jpeg",
        "NORMAL",
        Size(1500, 750),
        ExifOrientationHelper.NORMAL
    )
    val clockExifRotate90: MyResourceImage = MyResourceImage(
        "clock_exif_rotate_90.jpeg",
        "ROTATE_90",
        Size(750, 1500),
        ExifOrientationHelper.ROTATE_90
    )
    val clockExifRotate180: MyResourceImage = MyResourceImage(
        "clock_exif_rotate_180.jpeg",
        "ROTATE_180",
        Size(1500, 750),
        ExifOrientationHelper.ROTATE_180
    )
    val clockExifRotate270: MyResourceImage = MyResourceImage(
        "clock_exif_rotate_270.jpeg",
        "ROTATE_270",
        Size(750, 1500),
        ExifOrientationHelper.ROTATE_270
    )
    val clockExifTranspose: MyResourceImage = MyResourceImage(
        "clock_exif_transpose.jpeg",
        "TRANSPOSE",
        Size(750, 1500),
        ExifOrientationHelper.TRANSPOSE
    )
    val clockExifTransverse: MyResourceImage = MyResourceImage(
        "clock_exif_transverse.jpeg",
        "TRANSVERSE",
        Size(750, 1500),
        ExifOrientationHelper.TRANSVERSE
    )
    val clockExifUndefined: MyResourceImage = MyResourceImage(
    ...
    val number1: MyResourceImage = MyResourceImage("number_1.png", "NUMBER_1", Size(698, 776))
    val number2: MyResourceImage = MyResourceImage("number_2.png", "NUMBER_2", Size(698, 776))
    val number3: MyResourceImage = MyResourceImage("number_3.png", "NUMBER_3", Size(698, 776))
    val number4: MyResourceImage = MyResourceImage("number_4.png", "NUMBER_4", Size(698, 776))
    val number5: MyResourceImage = MyResourceImage("number_5.png", "NUMBER_5", Size(698, 776))
    val number6: MyResourceImage = MyResourceImage("number_6.png", "NUMBER_6", Size(698, 776))
    val number7: MyResourceImage = MyResourceImage("number_7.png", "NUMBER_7", Size(698, 776))
    val number8: MyResourceImage = MyResourceImage("number_8.png", "NUMBER_8", Size(698, 776))
    val number9: MyResourceImage = MyResourceImage("number_9.png", "NUMBER_9", Size(698, 776))
    val numbers =
        arrayOf(number1, number2, number3, number4, number5, number6, number7, number8, number9)

    val clockHor: MyResourceImage = MyResourceImage("clock_hor.jpeg", "CLOCK_HOR", Size(1500, 750))
    val clockVer: MyResourceImage = MyResourceImage("clock_ver.jpeg", "CLOCK_VER", Size(750, 1500))
    ...
    val values: Array<MyResourceImage> = arrayOf(
