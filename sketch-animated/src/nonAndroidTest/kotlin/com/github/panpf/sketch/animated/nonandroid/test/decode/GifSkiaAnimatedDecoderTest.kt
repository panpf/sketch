...
class GifSkiaAnimatedDecoderTest {
    ...
    fun testSupportAnimatedGif() {
        ...
        ComponentRegistry {
            ...
            assertEquals(
                expected = "ComponentRegistry(" +
                        "fetcherFactoryList=[]," +
                        "decoderFactoryList=[GifSkiaAnimatedDecoder]," +
                        "requestInterceptorList=[]," +
                        "decodeInterceptorList=[]" +
                        ")",
                actual = toString()
        ...
        ComponentRegistry {
            ...
            assertEquals(
                expected = "ComponentRegistry(" +
                        "fetcherFactoryList=[]," +
                        "decoderFactoryList=[GifSkiaAnimatedDecoder,GifSkiaAnimatedDecoder]," +
                        "requestInterceptorList=[]," +
                        "decodeInterceptorList=[]" +
                        ")",
                actual = toString()
    ...
    fun testEqualsAndHashCode() = runTest {
        ...
        val element1 = GifSkiaAnimatedDecoder(requestContext, dataSource)
        val element11 = GifSkiaAnimatedDecoder(requestContext, dataSource)
    ...
    fun testToString() = runTest {
        ...
        val requestContext = request.toRequestContext(sketch)
        val dataSource = ResourceImages.animGif.toDataSource(context)
        val decoder = GifSkiaAnimatedDecoder(requestContext, dataSource)
        assertTrue(actual = decoder.toString().contains("GifSkiaAnimatedDecoder"))
    ...
    fun testFactoryCreate() = runTest {
        ...
        ImageRequest(context, ResourceImages.animGif.uri)
            .createDecoderOrNull(sketch, factory) {
                ...
                assertTrue(actual = this is GifSkiaAnimatedDecoder)
            }
    ...
    fun testFactoryEqualsAndHashCode() {
        val element1 = GifSkiaAnimatedDecoder.Factory()
        val element11 = GifSkiaAnimatedDecoder.Factory()
    ...
    fun testFactoryToString() = runTest {
        assertEquals(
            expected = "GifSkiaAnimatedDecoder",
            actual = GifSkiaAnimatedDecoder.Factory().toString()
        )
    }
}