...
class GifDecodeUtilsTest {
    ...
    fun testIsWebP() {
        ...
        Bytes(context.assets.open(MyImages.webp.fileName).use {
            ByteArray(1024).apply { it.read(this) }
        }).apply {
            Assert.assertTrue(isWebP())
        }
        Bytes(context.assets.open(MyImages.animWebp.fileName).use {
            ByteArray(1024).apply { it.read(this) }
        }).apply {
            Assert.assertTrue(isWebP())
        }
        ...
        Bytes(context.assets.open(MyImages.jpeg.fileName).use {
            ByteArray(1024).apply { it.read(this) }
        }).apply {
            Assert.assertFalse(isWebP())
        }
    ...
    fun testIsHeif() {
        ...
        Bytes(context.assets.open(MyImages.heic.fileName).use {
            ByteArray(1024).apply { it.read(this) }
        }).apply {
    ...
    fun testIsAnimatedHeif() {
        ...
        Bytes(context.assets.open(MyImages.animHeif.fileName).use {
            ByteArray(1024).apply { it.read(this) }
        }).apply {
    ...
    fun testIsGif() {
        ...
        Bytes(context.assets.open(MyImages.animGif.fileName).use {
            ByteArray(1024).apply { it.read(this) }
        }).apply {
