...
public class ProgressPieView extends View {
    ...
    private static final int default_stroke_color = 0xFF33b5e5;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int backgroundColor = a.getColor(R.styleable.ProgressPieView_backgroundColor, default_background_color);
        int progressColor = a.getColor(R.styleable.ProgressPieView_progressColor, default_progress_color);
        int strokeColor = a.getColor(R.styleable.ProgressPieView_strokeColor, default_stroke_color);
        int textColor = a.getColor(R.styleable.ProgressPieView_android_textColor, default_text_color);
