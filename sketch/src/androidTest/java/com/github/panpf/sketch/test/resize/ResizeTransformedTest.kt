...
class ResizeTransformedTest {
    ...
    fun testKey() {
        ...
        ResizeTransformed(
            ...
            Assert.assertEquals(
                "ResizeTransformed(100x50,LongImageClip(SAME_ASPECT_RATIO,Default(2.5,5.0)),Fixed(CENTER_CROP))",
                key
            )
        }
        ResizeTransformed(
            ...
            Assert.assertEquals(
                "ResizeTransformed(100x50,LongImageClip(EXACTLY,Default(2.5,5.0)),Fixed(CENTER_CROP))",
                key
            )
        }
