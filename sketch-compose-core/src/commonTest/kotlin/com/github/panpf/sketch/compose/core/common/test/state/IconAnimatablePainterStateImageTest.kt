...
class IconAnimatablePainterStateImageTest {
    ...
    fun testKey() {
        ...
        IconAnimatablePainterStateImage(
            ...
            assertEquals(
                expected = "IconAnimatablePainterStateImage(icon=EquitableAnimatablePainter('TestAnimatablePainter(drawable=SizeColorPainter(color=Color(1.0, 0.0, 0.0, 1.0, sRGB IEC61966-2.1), size=Size.Unspecified))'),background=EquitablePainter('18413117194201202688'),iconSize=Size(44.0, 67.0),iconTint=Color(0.0, 0.0, 1.0, 1.0, sRGB IEC61966-2.1))",
                actual = key
            )
        }
    }
    ...
    fun testToString() {
        ...
        IconAnimatablePainterStateImage(
            ...
            assertEquals(
                expected = "IconAnimatablePainterStateImage(icon=EquitableAnimatablePainter(painter=PainterWrapper(painter=SizeColorPainter(color=Color(1.0, 0.0, 0.0, 1.0, sRGB IEC61966-2.1), size=Size.Unspecified)), equalityKey=TestAnimatablePainter(drawable=SizeColorPainter(color=Color(1.0, 0.0, 0.0, 1.0, sRGB IEC61966-2.1), size=Size.Unspecified))), background=EquitablePainter(painter=ColorPainter(color=-7829368), equalityKey=18413117194201202688), iconSize=Size(44.0, 67.0), iconTint=Color(0.0, 0.0, 1.0, 1.0, sRGB IEC61966-2.1))",
                actual = toString()
            )
        }
    }
