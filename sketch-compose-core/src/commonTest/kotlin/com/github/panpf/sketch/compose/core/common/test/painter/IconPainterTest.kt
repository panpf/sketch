...
class IconPainterTest {
    ...
    fun testToString() {
        assertEquals(
            expected = "IconPainter(icon=EquitablePainter(painter=SizeColorPainter(color=Color(1.0, 0.0, 0.0, 1.0, sRGB IEC61966-2.1), size=Size(100.0, 100.0)), equalityKey=SizeColorPainter(color=Color(1.0, 0.0, 0.0, 1.0, sRGB IEC61966-2.1), size=Size(100.0, 100.0))), background=EquitablePainter(painter=ColorPainter(color=-7829368), equalityKey=18413117194201202688), iconSize=Size(69.0, 44.0), iconTint=Color(0.0, 0.0, 1.0, 1.0, sRGB IEC61966-2.1))",
            actual = IconPainter(
